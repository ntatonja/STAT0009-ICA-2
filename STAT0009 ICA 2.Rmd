...
```
## Introduction
This is a report for the published study ‘A tutorial on particle filters’, by Maarten Speekenbrink. It was published in 2016 in Elsevier, and is
...
lines(rowSums(P*W)[-1], col = "purple")
